...
//       test('when list only has one blog, equals blog' , () => {
...
//       test('of a bigger list gets most liked', () => {
...
//       test('of a bigger list gets the first most liked', () => {
//         const result = listHelper.favouriteBlog(manyBlogsTwoFavourites)
//         assert.deepStrictEqual(result, 
//             {
//                 _id: "5a422a851b54a676234d17f7",
//                 title: "React patterns",
...
//       test('of a bigger list gets most blogs written', () => {
...
// describe('most blog likes total', () => {
//     const listWithOneBlog = [
//         {
//             _id: '5a422aa71b54a676234d17f8',
//             title: 'Go To Statement Considered Harmful',
...
//     test('when list only has one blog, equals blog like total', () =>{
...
//       test('of a bigger list gets most author likes', () => {
